...
namespace CafeShopManagementSystem
{
    public partial class CashierMainForm : Form
    {
        ...
        {
            DialogResult click = MessageBox.Show("Are you sure you want to exit?", "Confirmation Message", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
        ...
        private void addProducts_btn_Click(object sender, EventArgs e)
        {
            ...
            AdminAddProducts adPrd = adminAddProducts1 as AdminAddProducts;
            if (adPrd != null)
            {
                adPrd.refreshData();
            }
